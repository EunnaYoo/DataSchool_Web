...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="contents" align="left">
		<table valign="bottom">
			<td><a href="/da.db?cmd=snb_sqlp_1" class="tab"><img src="/publishing/img/certificate/tab1_snb21_on.gif" width="90px" height="27px" alt="자격소개"></a></td>
			<td><a href="/da.db?cmd=snb_sqlp_2" class="tab"><img src="/publishing/img/certificate/tab2_snb21.gif" width="90px" height="27px" alt="시험주요내용"></a></td>
			<td><a href="/da.db?cmd=snb_sqlp_3" class="tab"><img src="/publishing/img/certificate/tab3_snb21.gif" width="90px" height="27px" alt="출제문항및배점"></a></td>
			<td><a href="/da.db?cmd=snb_sqlp_4" class="tab"><img src="/publishing/img/certificate/tab4_snb21.gif" width="90px" height="27px" alt="응시자격및합격기준"></a></td>
		</table>
	</div>
	<h4 class="content_title top">SQLD/SQLP</h4>
      ...
      <h4 class="content_title top">데이터 분석 준전문가 정의</h4>
         
         
         <!--h5 class="sub_title">빅데이터란</h5-->
         <p class="indent">
